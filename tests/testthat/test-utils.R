test_that("test sanofi weights numeric ", {
  expect_silent(risk.assessr::check_risk_weights(sanofi_weights_numeric))
})

test_that("test sanofi weights negative numeric ", {
  expect_error(risk.assessr::check_risk_weights(sanofi_weights_numeric_prob))
})

test_that("test sanofi weights non numeric ", {
  expect_error(risk.assessr::check_risk_weights(sanofi_weights_non_numeric))
}) 
