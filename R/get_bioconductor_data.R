...
#' 
#' [[1]]$url
#' [1] "https://bioconductor.org/packages/GenomicRanges"
#' 
#' [[1]]$source_package
#' [1] "https://bioconductor.org/packages/3.14/bioc/src/contrib/GenomicRanges_1.46.1.tar.gz"
#' 
#' [[1]]$bioconductor_version
#' [1] "3.14"
#' 
#' [[1]]$url_package
#' [1] "https://bioconductor.org/packages/GenomicRanges"
...
#' 
#' [[2]]$source_package
#' [1] "https://bioconductor.org/packages/3.14/bioc/src/contrib/Archive/GenomicRanges/"
#' 
#' [[2]]$archived
#' [1] TRUE
#' 
#' [[2]]$bioconductor_version
#' [1] "3.14"
#' }
#' @export
