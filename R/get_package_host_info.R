...
#' $url
#'[1] "https://rstudio-pm.prod/internal/internalpackage/myinternalpackage_1.0.1.tar.gz"
#'$last_version
#'[1] "2.0.0"
#'$all_versions
#'[1] "2.0.0"  "1.3.14" "1.3.13"
#'}
...
get_internal_package_url <- function(package_name, version = NULL,
  ...
  data <- tryCatch({
    ...
    cat("Failed to parse JSON response:", conditionMessage(e), "\n")
    return(NULL)
  })
...
#' check_and_fetch_cran_package("ggplot2", package_version = "3.3.5")
#' $package_url
#'[1] "https://cran.r-project.org/src/contrib/Archive/ggplot2/ggplot2_3.3.5.tar.gz"
#'
#'$last_version
#'[1] "3.5.1"
#'
...
#'$all_versions
#'[1] "3.3.6"   "3.4.0"   "3.4.1"   "3.4.2"   "3.4.3"   "3.4.4"   "3.5.0"   "3.5.1"  
#'}
#' @importFrom curl curl_fetch_memory
#' @importFrom jsonlite fromJSON
#' @export
