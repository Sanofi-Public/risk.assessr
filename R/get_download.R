...
#' @examples
#' \dontrun{
#' extract_aria_label('<svg aria-label="CRAN downloads 1.2M">...</svg>')
#' "CRAN downloads 1.2M"
#' }
#' @keywords internal
...
#' @examples
#' \dontrun{
#' convert_abbreviation_to_number('1.2M') 
#' # 1200000
#' convert_abbreviation_to_number('500K') 
#'
#' convert_abbreviation_to_number('100')
#' # 100
#' }
#' @keywords internal
