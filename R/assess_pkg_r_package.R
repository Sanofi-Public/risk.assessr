...
#'
#' This function use `sanofi.risk.assessr::assess_pkg` assessment function with only the package name and version
#'
...
#'
#' @return The function returns a list of assessment results generated by the `sanofi.risk.assessr::assess_pkg` function. 
#' If the package cannot be downloaded or installed, an error message is returned.
#'
#' @details This function follows these steps:
#' \enumerate{
#'   \item Downloads the specified R package using the `sanofi.risk.assessr::get_tar_package` function.
#'   \item Installs the downloaded package in a temporary location.
#'   \item Runs the `sanofi.risk.assessr::assess_pkg` function to assess the package for risks and issues.
...
#' }
#'
#' @importFrom sanofi.risk.assessr get_tar_package set_up_pkg assess_pkg
#' @importFrom utils download.file
#' @export
assess_pkg_r_package <- function(package_name, version=NA) {
  package_data <- sanofi.risk.assessr::get_tar_package(package_name, version=version)
